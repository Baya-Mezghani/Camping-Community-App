            ...
            comments.map(comment => (
                <article className="max-w-screen-md py-4">
                    <div className="w-full flex justify-center items-start">
                        <div className="w-24">
                            <img
                                src={comment.author.avatar|| `https://images.unsplash.com/photo-1565588496723-63494874b143?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=866&q=80`}
